...
const STORIES: Record<string, StoryApplication> = {
  ...
  hosea: {
    title: "호세아 — 다시 사랑하라는 명령을 받는 장면",
    body: [
      "겉으로는 배신당한 남편의 장면으로 읽힙니다.",
      "그 안에는 '왜 다시 가야 하는가'라는 물음이 있었습니다.",
      "그러나 호세아는 고멜을 다시 데려오며 하나님의 사랑을 배웁니다.",
    ],
    closing: "배신의 장면이 아니라, 사랑의 장면입니다.",
  },
  amos: {
    title: "아모스 — 정의를 외치는 목자의 장면",
    body: [
      "겉으로는 거친 목자가 궁전에 선 장면으로 읽힙니다.",
      "그 안에는 '내가 무슨 자격으로'라는 두려움이 있었습니다.",
      "그러나 아모스는 물 같이 흐르는 정의를 외치며 백성을 깨웁니다.",
    ],
    closing: "두려움의 장면이 아니라, 외침의 장면입니다.",
  },
  micah: {
    title: "미가 — 베들레헴을 바라보는 장면",
    body: [
      "겉으로는 작은 마을을 바라보는 장면으로 읽힙니다.",
      "그 안에는 '작은 곳에서 무엇이 나겠는가'라는 물음이 있었습니다.",
      "그러나 미가는 베들레헴에서 나오실 분을 바라보며 소망을 전합니다.",
    ],
    closing: "작음의 장면이 아니라, 소망의 장면입니다.",
  },
  zechariah: {
    title: "스가랴 — 다시 세우라는 약속을 듣는 장면",
    body: [
      "겉으로는 무너진 성전을 바라보는 장면으로 읽힙니다.",
      "그 안에는 '다시 될까'라는 의심이 있었습니다.",
      "그러나 스가랴는 순금 등대와 감람나무의 환상을 보며 약속을 붙잡습니다.",
    ],
    closing: "무너짐의 장면이 아니라, 약속의 장면입니다.",
  },
};
